...
public class RandomValueUtil {
     ...
     * 人名的list
     *
     * @param length 需要生成的人名的数量
     * @return List<String>
     */
    public static List<String> getChineseName(Integer length) {
     ...
     * 邮箱地址的list
     *
     * @param length 需要生成的邮箱地址的数量
     * @return List<String>
     */
    public static List<String> getEmail(Integer length) {
        List<String> list = Lists.newArrayList();
        if (length == null) length = 0;
        for (int i = 0; i < length; i++) {
            list.add(getEmail(8, 10));
        }
        return list;
    }
     ...
     * 手机号码的list
     *
     * @param length 需要生成的手机号码的数量
     * @return List<String>
     */
    public static List<String> getMobile(Integer length) {

        List<String> list = Lists.newArrayList();
        if (length == null) length = 0;
        for (int i = 0; i < length; i++) {
            list.add(getLandline());
        }
        return list;
    }
